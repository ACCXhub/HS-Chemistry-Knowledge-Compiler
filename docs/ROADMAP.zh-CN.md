...
以下 M4–M25 为历史范围，M8/M21/M25 的当时限制已由上述纠正更新。当前数量与缺口见[课程覆盖](CURRICULUM_COVERAGE.zh-CN.md)，应用接口见[契约](contracts/APPLICATION_API.zh-CN.md)。推荐下一里程碑为课程覆盖批次 A；尚未开始。
